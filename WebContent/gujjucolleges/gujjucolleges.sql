...
--
-- Host: localhost
-- Generation Time: Oct 21, 2013 at 02:36 PM
...
CREATE TABLE IF NOT EXISTS `clg_mstr` (
  `CLG_ID` int(10) NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `clg_contact`
  ADD CONSTRAINT `clg_contact_ibfk_1` FOREIGN KEY (`CLG_ID`) REFERENCES `clg_mstr` (`CLG_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `clg_dept_mstr`
--
ALTER TABLE `clg_dept_mstr`
  ADD CONSTRAINT `clg_dept_mstr_ibfk_1` FOREIGN KEY (`CLG_ID`) REFERENCES `clg_mstr` (`CLG_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `clg_plcmnt_mstr`
--
ALTER TABLE `clg_plcmnt_mstr`
  ADD CONSTRAINT `clg_plcmnt_mstr_ibfk_3` FOREIGN KEY (`CLG_ID`) REFERENCES `clg_mstr` (`CLG_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `clg_plcmnt_mstr_ibfk_4` FOREIGN KEY (`DEPT_ID`) REFERENCES `clg_dept_mstr` (`DEPT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `hostel_mstr`
--
ALTER TABLE `hostel_mstr`
  ADD CONSTRAINT `hostel_mstr_ibfk_1` FOREIGN KEY (`CLG_ID`) REFERENCES `clg_mstr` (`CLG_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
