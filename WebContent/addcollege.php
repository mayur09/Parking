...
<section id="content">
		...
		<div class="container clearfix">
			...
			<div class="six columns clearfix">
				...
				<div id="addform">
					<form method="POST" action="addcontact_logo.php" enctype="multipart/form-data">
					<input required="" type="file" name="file" id="col_logo"/>
					...
					<input required="" type="radio" name="clg_type" id="clg_type" value="SemiSelf Finance"/>
