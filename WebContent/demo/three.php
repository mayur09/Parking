...
<section id="content">
		...
		<div class="container">
			...
			<div class="four columns label compare">
				...
				<h6>
					<ul>
						<li style="margin:0px 0px 10px 0px;"><img src="./images/logos/<?php echo $logo3;?>"></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $name3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $ctgry3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $aicte3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $fees3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $phone3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $email3;?></li>
						<li style="margin:0px 0px 10px 0px;"><?php echo $web3;?></li>
